...
def find_permutation(x, y, it, tau, n_samples, epochs, lr, loss_type='l2', alpha=0.0, ones=True, graphs=True):
    if graphs:
...
def got_align(g1,g2):
    ...
    sbm_x_inv, sbm_y_inv, sbm_P = find_permutation(l1, l2, it=10, tau=2,
                                                   n_samples=20, epochs=600, lr=0.5,

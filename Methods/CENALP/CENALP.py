...
import pandas as pd
from utils import *
from Methods.CENALP.walks import multi_simulate_walks, single_simulate_walks
...
from Methods.CENALP.model import structing
data_folder = '../graph/'
attribute_folder = '../attribute/'
alignment_folder = '../alignment/'

def CENALP(G1, G2, q, attribute, alignment_dict, alignment_dict_reversed,
